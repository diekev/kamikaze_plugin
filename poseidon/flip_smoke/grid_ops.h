...
/* subtract a grid or tree from another grid or tree */
template<typename GridOrTreeT>
inline void compSub(GridOrTreeT &aTree, GridOrTreeT &bTree)
{
	typedef openvdb::TreeAdapter<GridOrTreeT> Adapter;
